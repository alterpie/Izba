...
import com.yerastov.android.izba.domain.ProductUnit

/**
 * Created by yerastov on 29/09/17.
 */
internal class ProductUnitAdapter(context: Context) : BaseAdapter() {
    private val items = ProductUnit.createAvailableList(context)
    ...
    override fun getItem(position: Int): ProductUnit = items[position]
